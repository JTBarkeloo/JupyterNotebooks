...
Optimization of Loss Calculation Model for Rural Vs. Urban Drivers
\begin{itemize}
...
Analysis of Loss vs. Adherance to Speed Limit
\begin{itemize}
...
\item Driver Sex - Another historical rate factor that would be both interesting to analysis and I have always been curious about
...
\begin{itemize}
\item Question 1 (Rural/Urban Loss):  Equal sized data sets (50k each, Rural/Urban Drivers) with the additional variables should be sufficient for results to measure the ability to calculate loss probability between the two classes
